         ...
         <div class="columns is-centered">
           <div class="column is-4">
               <div class="box">
                 ...
                 <form  @submit.prevent="onSubmit" >
                   ...
                   <div class="field">
                     ...
                     <div class="control has-icons-left">
                        <input id="password" name="password" class="input" type="password" autocomplete="off" autocapitalize="off" v-model="password" >
                        <span class="icon is-small is-left">
                          <Lock :size="20" />
                        </span>
                     </div>
                   ...
                   <div class="field">
                     <div class="control has-text-centered">
                        <a class="button is-ghost" href="/#/recuperar">¿ Olvide la contraseña ?</a>                       
                     </div>
                   </div>
                 </form>
               </div> 
               ...
               <div class="column has-text-centered">
                  <a class="button is-ghost" href="/#/crear-cuenta" >Crear cuenta</a>
               </div>
...
<script setup >
 ...
 const password = ref("1234566");

 function onSubmit(){
      axios({
          "method":"post",
          "url":"https://csweb.sistematizate.cl/login"
        }).then(( response)=>{
